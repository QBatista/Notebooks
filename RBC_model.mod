...
stoch_simul(irf=40, periods=300, drop=100) log_y log_c log_invest log_n log_y_n log_w r a;
csvwrite('simulated_data.csv', [log_y log_c log_invest log_n log_y_n log_w r a]);
